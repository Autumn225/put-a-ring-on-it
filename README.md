...
### **FEATURES**
- Automatically create customizable token rings for tokens placed on scenes
...
- Compatible with Tokenizer, system tokens, and JB2A tokens, will not apply token rings to them by default.
- Requires libWrapper only
